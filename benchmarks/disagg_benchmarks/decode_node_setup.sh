...
CUDA_VISIBLE_DEVICES=0 vllm serve "$MODEL" \
    ...
    --kv-transfer-config \
    "{\"kv_connector\":\"P2pNcclConnector\",\"kv_role\":\"kv_consumer\",\"kv_rank\":1,\"kv_parallel_size\":2,\"kv_buffer_size\":1e9,\"kv_connector_extra_config\":{\"mem_pool_size_gb\":4}}" > decode_server.log 2>&1 &
