...
CUDA_VISIBLE_DEVICES=0 vllm serve "$MODEL" \
    ...
    --kv-transfer-config \
    "{\"kv_connector\":\"BatchedNcclConnector\",\"kv_role\":\"kv_producer\",\"kv_rank\":0,\"kv_parallel_size\":2,\"kv_buffer_size\":1.5e9,\"kv_ip\":\"${DECODE_IP}\",\"kv_port\":14579,\"kv_connector_extra_config\":{\"mem_pool_size_gb\":8,\"kv_granularity\":${KV_GRANULARITY}}}" > prefill_server.log 2>&1 &
